...
<p align="center">
  ...
  <a href="https://github.com/OyeAmeliaa/KanhaMusic/releases">
  ...
  <a href="https://github.com/OyeAmeliaa/KanhaMusic/blob/dev/LICENSE">
...
<p align="center">
  <a href="https://heroku.com/deploy?template=https://github.com/OyeAmeliaa/KanhaMusic">
    <img src="https://www.herokucdn.com/deploy/button.svg" alt="Deploy to Heroku" height="38">
  </a>
  &nbsp;&nbsp;&nbsp;
  <a href="https://railway.com/new/template?template=https://github.com/OyeAmeliaa/KanhaMusic">
    <img src="https://railway.com/button.svg" alt="Deploy on Railway" height="38">
  </a>
  &nbsp;&nbsp;&nbsp;
  <a href="https://render.com/deploy?repo=https://github.com/OyeAmeliaa/KanhaMusic">
    <img src="https://render.com/images/deploy-to-render-button.svg" alt="Deploy to Render" height="38">
  </a>
  &nbsp;&nbsp;&nbsp;
  <a href="https://app.koyeb.com/deploy?type=git&repository=OyeAmeliaa/KanhaMusic&branch=dev&name=Ameliamusic&service_type=worker&env[API_ID]=&env[API_HASH]=&env[TOKEN]=&env[MONGO_DB_URI]=&env[STRING_SESSION]=&env[OWNER_ID]=">
...
<details>
  ...
  git clone https://github.com/OyeAmeliaa/KanhaMusic.git
  cd KanhaMusic
  ...
  **Method 1: Using Tmux (Recommended)**
  ```bash
  tmux new -s Ameliamusic
  ./app
  # Press Ctrl+B then D to detach. Re-attach anytime with: tmux a -t Ameliamusic
  ```

  **Method 2: Using Systemd Service**
  ```bash
  sudo nano /etc/systemd/system/Ameliamusic.service
  ```
  ...
  sudo systemctl enable Ameliamusic
  sudo systemctl start Ameliamusic
  sudo systemctl status Ameliamusic
  ```
</details>
...
<details>
  ...
  docker compose logs -f Ameliamusic

  # Restart the bot
  docker compose restart Ameliamusic
...
<p align="center">
  <b>Developed & Maintained with ❤️ by <a href="https://github.com/OyeAmeliaa">Kanha</a></b>
</p>
